 ...
 * <ul>
 *   <li>{@link es.uca.spifm.spdt.genericTools.wikim.Category#getParentCategory <em>Parent Category</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Category extends WikiContent {
	 ...
	 * @see es.uca.spifm.spdt.genericTools.wikim.WikimPackage#getCategory_ParentCategory()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.uca.spifm.spdt.genericTools.wikim.Category#getParentCategory <em>Parent Category</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
