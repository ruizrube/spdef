 ...
 * @generated
 */
public class ItmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ItmPackage.ISSUE_TRACKING_DATABASE: {
				IssueTrackingDatabase issueTrackingDatabase = (IssueTrackingDatabase)theEObject;
				T result = caseIssueTrackingDatabase(issueTrackingDatabase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.VERSION: {
				Version version = (Version)theEObject;
				T result = caseVersion(version);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.ISSUE: {
				Issue issue = (Issue)theEObject;
				T result = caseIssue(issue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.TRACKER: {
				Tracker tracker = (Tracker)theEObject;
				T result = caseTracker(tracker);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.ISSUE_DEPENDENCY: {
				IssueDependency issueDependency = (IssueDependency)theEObject;
				T result = caseIssueDependency(issueDependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.ISSUE_CATEGORY: {
				IssueCategory issueCategory = (IssueCategory)theEObject;
				T result = caseIssueCategory(issueCategory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.MEMBER: {
				Member member = (Member)theEObject;
				T result = caseMember(member);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.USER: {
				User user = (User)theEObject;
				T result = caseUser(user);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ItmPackage.ROLE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Issue Tracking Database</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Issue Tracking Database</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIssueTrackingDatabase(IssueTrackingDatabase object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Issue Dependency</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Issue Dependency</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIssueDependency(IssueDependency object) {
		return null;
	}
