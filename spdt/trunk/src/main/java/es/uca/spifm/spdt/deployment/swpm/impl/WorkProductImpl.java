...
public abstract class WorkProductImpl extends MinimalEObjectImpl.Container implements WorkProduct {
	...
	protected EClass eStaticClass() {
		return SwpmPackage.Literals.WORK_PRODUCT;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SwpmPackage.WORK_PRODUCT__DESCRIPTION, oldDescription, description));
	}
