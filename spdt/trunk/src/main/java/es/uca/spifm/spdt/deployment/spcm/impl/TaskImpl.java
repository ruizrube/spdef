 ...
 *   <li>{@link es.uca.spifm.spdt.deployment.spcm.impl.TaskImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link es.uca.spifm.spdt.deployment.spcm.impl.TaskImpl#getStatus <em>Status</em>}</li>
...
public class TaskImpl extends MinimalEObjectImpl.Container implements Task {
	 ...
	 * @ordered
	 */
	protected static final TaskStatus STATUS_EDEFAULT = TaskStatus.OPEN;
	...
	public void setStatus(TaskStatus newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpcmPackage.TASK__STATUS, oldStatus, status));
	}
