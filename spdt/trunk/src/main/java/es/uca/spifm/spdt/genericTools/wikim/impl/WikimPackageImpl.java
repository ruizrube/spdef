...
import es.uca.spifm.spdt.genericTools.wikim.File;
...
public class WikimPackageImpl extends EPackageImpl implements WikimPackage {
	 ...
	 * @see es.uca.spifm.spdt.genericTools.wikim.WikimPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
