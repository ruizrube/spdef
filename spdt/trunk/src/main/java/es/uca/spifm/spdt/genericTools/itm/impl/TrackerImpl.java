 ...
 * <ul>
 *   <li>{@link es.uca.spifm.spdt.genericTools.itm.impl.TrackerImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TrackerImpl extends MinimalEObjectImpl.Container implements Tracker {
	...
	protected EClass eStaticClass() {
		return ItmPackage.Literals.TRACKER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ItmPackage.TRACKER__NAME, oldName, name));
	}
