 ...
 * <ul>
 *   <li>{@link es.uca.spifm.spdt.specificTools.wikim.impl.ItemListImpl#getItems <em>Items</em>}</li>
 *   <li>{@link es.uca.spifm.spdt.specificTools.wikim.impl.ItemListImpl#getTitle <em>Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ItemListImpl extends SectionContentImpl implements ItemList {
	/**
	...
	protected EClass eStaticClass() {
		return WikimPackage.Literals.ITEM_LIST;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, WikimPackage.ITEM_LIST__ITEMS);
		}
		return items;
	}
