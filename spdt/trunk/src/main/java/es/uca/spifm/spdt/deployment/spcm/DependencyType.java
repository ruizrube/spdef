 ...
 * <!-- end-user-doc -->
 * @see es.uca.spifm.spdt.deployment.spcm.SpcmPackage#getDependencyType()
 * @model annotation="comment comment='Enumeraci\363n con los diferentes tipos de dependencia entre tareas.'"
 * @generated
 */
