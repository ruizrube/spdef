 ...
 * <ul>
 *   <li>{@link es.uca.spifm.spdt.specificTools.wikim.impl.SectionImpl#getEmbeddedSections <em>Embedded Sections</em>}</li>
 *   <li>{@link es.uca.spifm.spdt.specificTools.wikim.impl.SectionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link es.uca.spifm.spdt.specificTools.wikim.impl.SectionImpl#getText <em>Text</em>}</li>
 *   <li>{@link es.uca.spifm.spdt.specificTools.wikim.impl.SectionImpl#getContents <em>Contents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SectionImpl extends MinimalEObjectImpl.Container implements Section {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case WikimPackage.SECTION___RENDER__INT:
				return render((Integer)arguments.get(0));
		}
