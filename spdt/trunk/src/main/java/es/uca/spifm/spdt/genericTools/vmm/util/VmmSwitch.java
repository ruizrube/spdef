 ...
 * @generated
 */
public class VmmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VmmPackage.MODEL_REPOSITORY: {
				ModelRepository modelRepository = (ModelRepository)theEObject;
				T result = caseModelRepository(modelRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VmmPackage.PACKAGE: {
				es.uca.spifm.spdt.genericTools.vmm.Package package_ = (es.uca.spifm.spdt.genericTools.vmm.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VmmPackage.DIAGRAM: {
				Diagram diagram = (Diagram)theEObject;
				T result = caseDiagram(diagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VmmPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VmmPackage.CONNECTOR: {
				Connector connector = (Connector)theEObject;
				T result = caseConnector(connector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VmmPackage.PROJECT: {
	 ...
	 * @generated
	 */
	public T casePackage(es.uca.spifm.spdt.genericTools.vmm.Package object) {
		return null;
	}
