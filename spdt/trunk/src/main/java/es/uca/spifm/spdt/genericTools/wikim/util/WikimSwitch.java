 ...
 * @generated
 */
public class WikimSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WikimPackage.CATEGORY: {
				...
				if (result == null) result = caseWikiContent(category);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WikimPackage.WIKI_CONTENT: {
				WikiContent wikiContent = (WikiContent)theEObject;
				T result = caseWikiContent(wikiContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case WikimPackage.WIKI_DATABASE: {
				WikiDatabase wikiDatabase = (WikiDatabase)theEObject;
				T result = caseWikiDatabase(wikiDatabase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WikimPackage.ARTICLE: {
				...
				if (result == null) result = caseWikiContent(article);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WikimPackage.IMAGE: {
				...
				if (result == null) result = caseSectionContent(image);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WikimPackage.SECTION_CONTENT: {
			...
			case WikimPackage.PARAGRAPH: {
				...
				if (result == null) result = caseSectionContent(paragraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WikimPackage.ITEM_LIST: {
				...
				if (result == null) result = caseSectionContent(itemList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case WikimPackage.FILE: {
				...
				if (result == null) result = caseWikiContent(file);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WikimPackage.USER: {
				...
				if (result == null) result = caseWikiContent(user);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Wiki Content</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Wiki Content</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWikiContent(WikiContent object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Wiki Database</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Wiki Database</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWikiDatabase(WikiDatabase object) {
		return null;
	}
