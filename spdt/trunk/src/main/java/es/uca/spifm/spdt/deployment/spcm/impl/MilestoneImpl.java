...
public class MilestoneImpl extends MinimalEObjectImpl.Container implements Milestone {
	...
	protected EClass eStaticClass() {
		return SpcmPackage.Literals.MILESTONE;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpcmPackage.MILESTONE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpcmPackage.MILESTONE__NAME, oldName, name));
	}
	...
	public EList<Task> getTasks() {
		if (tasks == null) {
			tasks = new EObjectContainmentEList<Task>(Task.class, this, SpcmPackage.MILESTONE__TASKS);
		}
		return tasks;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SpcmPackage.MILESTONE__DESCRIPTION:
				return getDescription();
			case SpcmPackage.MILESTONE__NAME:
				return getName();
			case SpcmPackage.MILESTONE__TASKS:
				return getTasks();
		}
