	...
	protected void createCommentAnnotations() {
		...
		addAnnotation
		  (projectEClass, 
		   source, 
		   new String[] {
			 "comment", "Clase contenedora de todos las tareas y milestones establecidos para la planificaci\u00f3n y monitorizaci\u00f3n de un proyecto software."
		   });		
		addAnnotation
		  (milestoneEClass, 
		   source, 
		   new String[] {
			 "comment", "Clase que representa los hitos del desarrollo o versiones del software durante el transcurso de los proyectos."
		   });		
		addAnnotation
		  (roleEClass, 
		   source, 
		   new String[] {
			 "comment", "Clase que representa el papel que juega un determinado miembro de un proyecto de desarrollo o mantenimiento de software."
		   });		
		addAnnotation
		  (taskEClass, 
		   source, 
		   new String[] {
			 "comment", "Clase que define la acci\u00f3n de realizar una labor necesaria para conseguir los objetivos del proyecto."
		   });		
		addAnnotation
		  (taskCategoryEClass, 
		   source, 
		   new String[] {
			 "comment", "Clase que permite categorizar una tarea seg\u00fan su \u00e1mbito de aplicaci\u00f3n."
		   });		
		addAnnotation
		  (dependencyTypeEEnum, 
		   source, 
		   new String[] {
			 "comment", "Enumeraci\u00f3n con los diferentes tipos de dependencia entre tareas."
		   });		
		addAnnotation
		  (taskDependencyEClass, 
		   source, 
		   new String[] {
			 "comment", "Clase de asociaci\u00f3n que permite representar la dependencia entre dos tareas concretas."
		   });
	}
