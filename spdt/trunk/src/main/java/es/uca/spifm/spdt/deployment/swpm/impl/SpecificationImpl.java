...
public class SpecificationImpl extends MinimalEObjectImpl.Container implements Specification {
	 ...
	 * @ordered
	 */
	protected static final SpecificationType TYPE_EDEFAULT = SpecificationType.TEXTUAL;
	...
	protected EClass eStaticClass() {
		return SwpmPackage.Literals.SPECIFICATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SwpmPackage.SPECIFICATION__NAME, oldName, name));
	}
	...
	public void setType(SpecificationType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SwpmPackage.SPECIFICATION__TYPE, oldType, type));
	}
